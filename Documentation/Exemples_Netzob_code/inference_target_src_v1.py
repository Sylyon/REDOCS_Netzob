...
msgs_session1 = PCAPImporter.readFile("target_src_v1_session1.pcap").values()
msgs_session2 = PCAPImporter.readFile("target_src_v1_session2.pcap").values()
...
## Step 8
print "\n[++++++++++++++++++++ Create the automata, generate trafic and send it to the server ++++++++++++++++++++]\n"

# Create a session of messages
msgs_session3 = PCAPImporter.readFile("target_src_v1_session3.pcap").values()
