...
\title{Using Netzob for protocol reverse engineering }   
...
\node (AI)     [process, below of=CF]          {Assess impact of the fields};

\node (VH)     [process, below of=AI]          {Verify hypothesis};
...
\begin{frame}{\bf Assessing the Impact of the Fields}
\begin{center}
\scalebox{0.9}{
\begin{tikzpicture}[node distance=1.5cm,
    every node/.style={fill=white, font=\sffamily}, align=center]
...
\node (AI)     [startstop, below of=CF]          {Assess impact of the fields};
...
\begin{frame}{\bf Finding Incrementation }
\begin{center}
...
\node (VH)     [startstop, below of=AI]          {Verify hypothesis};
